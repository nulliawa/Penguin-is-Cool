...
Icicle - https://itch.io/t/2995590/ice-spells-pixel-vfx-for-your-game
 */
...
//    private static final Image[] projectiles=new Image[projNames.length+7+4];//7 snowflakes, 4 icicles
...
//            projectiles[ice+7]=new ImageIcon("icicle"+ice+".png").getImage().getScaledInstance(50,30,Image.SCALE_SMOOTH);
//        }
...
//        }
//        for(int m=6;m<12;m++){//6 death frames
//            int ind=m-6;
