...
//    });
    ...
    public void drawTutorial(Graphics g) {
        ...
        if (next.isClicked(mx, my, mb) && tutorialScreen < 1) {
            tutorialScreen++;
            mb = 0;
        }
        ...
        switch (tutorialScreen) {
            case 0:
                ...
                g.drawString("Fish heals Penguin 1 HP each!", 20, 70);
                g.drawString("Dodge enemy projectiles to help Penguin gain 3 fish!", 20, 110);
                g.drawString("Fight the final orca boss for a boatload of fish...", 20, 150);
                break;
            case 1:
                // Controls
                g.setColor(MAIN);
